...
NFW_INTEGRATION:
	...
	if ( empty($_SESSION['email_install']) ) {
		...
		$message = __('Hi,') . "\n\n";
		$message.= __('This is NinjaFirewall\'s installer. Below are some info and links that could be helpful if you were having problems installing NinajFirewall:') . "\n\n";
		$message.= "------------------------------------------------------------------------\n\n";
