...
<div class="wrap">
	...
	// Skip that section if we are running with HHVM:
	if ($_SESSION['http_server'] != 7) {
		$chg_str1 = __('If one day you wanted to uninstall NinjaFirewall, you would need to manually undo your modifications before uninstalling it.', 'ninjafirewall');
