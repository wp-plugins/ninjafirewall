...
<div class="wrap">
	...
	<br />
	1 - <?php _e('Use ONLY your WordPress administration dashboard ("Plugins" page) to activate, deactivate, install, update, upgrade, uninstall or even delete NinjaFirewall.', 'ninjafirewall') ?>
	<br />
	2 - <?php _e('Do NOT attempt to perform any of the above operations using another application ( FTP, cPanel, Plesk etc), or to modify, rename, move, edit, or overwrite its files, EVEN when it is disabled.', 'ninjafirewall') ?>
	<br />
	3 - <?php _e('Do NOT attempt to migrate your site with NinjaFirewall installed. Uninstall it, migrate your site and reinstall it.', 'ninjafirewall') ?>
	<br />
	<br />
	...
	<br />
	<?php printf( __('If you need some help regarding the installation, please consult our <a href="%s">site</a>.', 'ninjafirewall'), 'http://ninjafirewall.com/') ?>
	<br />
...
<div class="wrap">
	...
	echo '
	<form method="post">
	<p>' . sprintf(__('Your WordPress directory (%s) is different from your website document root (%s). Because it is possible to install WordPress into a subdirectory, but have the blog exist in the site root, NinjaFirewall needs to know the exact location of the blog site root.', 'ninjafirewall'), '<code>' . ABSPATH . '</code>', '<code>' . htmlspecialchars( $_SERVER['DOCUMENT_ROOT'] ) . '/</code>') . '</p>
...
NFW_INTEGRATION:
	...
	if ( empty($_SESSION['email_install']) ) {
		...
		if ( $recipient = get_option('admin_email') ) {
			$subject = '[NinjaFirewall] ' . __('Installation & Troubleshooting Guide', 'ninjafirewall');
			$message = __('Hi,') . "\n\n";
			$message.= __('This is NinjaFirewall\'s installer. Below are some info and links that can be helpful:', 'ninjafirewall') . "\n\n";
			$message.= "------------------------------------------------------------------------\n\n";
			$message.= __('You are locked out of your site, blocked by NinjaFirewall or WordPress crashed right after installing NinjaFirewall? Follow this link:', 'ninjafirewall') . "\n   http://ninjafirewall.com/wordpress/help.php#lockedout\n\n";
			$message.= "------------------------------------------------------------------------\n\n";
			$message.= __('NinjaFirewall returns a "firewall is not loaded" error message? Follow this link:', 'ninjafirewall') . "\n   http://ninjafirewall.com/wordpress/help.php#troubleshooting\n\n";
			$message.= "------------------------------------------------------------------------\n\n";
			...
			$message.= "------------------------------------------------------------------------\n\n";
			$message.= __('Keep your blog protected against the latest vulnerabilities with NinjaFirewall automatic updates for security rules:', 'ninjafirewall') . "\n   http://blog.nintechnet.com/ninjafirewall-wpwp-introduces-automatic-updates-for-security-rules/\n\n";
			$message.= "------------------------------------------------------------------------\n\n";
			$message.= __('You can also check our FAQ and Installation Help:', 'ninjafirewall') . ' http://ninjafirewall.com/wordpress/help.php' . "\n";
...
<div class="wrap">
	...
	?>
		<br />
		<?php
		// translators: ...email was sent to [admin_email_address]
		_e('A "Installation & Troubleshooting Guide" email was sent to', 'ninjafirewall') ?> <code><?php echo $recipient ?></code>.
	<?php
	}
	?>
	</p></div>
