...
<div class="wrap">
	...
	<form method="post">
		...
		<input type="hidden" name="nfw_act" value="10" />
	</form>
</div>
<?php
...
function nfw_ini_data() {
	...
	define( 'HTACCESS_MODPHP', 'php_value auto_prepend_file ' . 	plugin_dir_path(__FILE__) .
		'lib/firewall.php' );
	define( 'HTACCESS_CGI_01', "<IfModule mod_env.c>\n SetEnv PHPRC " );
