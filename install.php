...
DENY;
		...
		file_put_contents(WP_CONTENT_DIR . '/nfwlog/.htaccess', $deny_rules, LOCK_EX);
		file_put_contents(WP_CONTENT_DIR . '/nfwlog/cache/.htaccess', $deny_rules, LOCK_EX);
		file_put_contents(WP_CONTENT_DIR . '/nfwlog/readme.txt', "This is NinjaFirewall's logs and cache directory.", LOCK_EX);
	}
	if ( empty($err) ) {
		nfw_chk_docroot( 0 );
		return;
