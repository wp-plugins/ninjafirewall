	...
	<table border="0" cellspacing="2" cellpadding="5" width="100%">
		...
		<tr>
			<td>
				...
				<p><b>Access Control</b> can be used to whitelist/blacklist an IP or any part of it. With its native dual-stack implementation, NinjaFirewall supports both IPv4 and IPv6 protocols:</p>
