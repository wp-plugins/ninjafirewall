...
echo '<br />
	...
	<table class="form-table">
		<tr>
			<th scope="row">' . __('Firewall protection', 'ninjafirewall') . '</th>';
// Enabled :
...
?></textarea>
	...
	<table class="form-table">
		...
		<tr>
			...
			<td width="20">&nbsp;</td>
			<td align="left"><input type="file" name="nf_imp" /><br /><span class="description"><?php printf( __( 'Imported configuration must match plugin version %s.<br />It will override all your current firewall options and rules.', 'ninjafirewall' ), NFW_ENGINE_VERSION ) ?></span></td>
		</tr>
	</table>
